<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseOnNet.aspx.cs" Inherits="PurchaseOnNet" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>新股网上申购申请</title>
    <style>
...
<body>
    ...
    <div>
        <h2 style="text-align: center">新股网上申购审批表</h2>
        <table width="100%" cellspacing="0" cellpadding="0" class="table-a">
            ...
            <tr>
                ...
                <Columns> 
                    ...
                    <asp:BoundField DataField="UpLimitVolOnNet0" HeaderText="上限(股)"  
                        DataFormatString="{0:N0}" HtmlEncode="False" ItemStyle-HorizontalAlign="Right"
                        HeaderStyle-HorizontalAlign="Right" > 
                        <HeaderStyle HorizontalAlign="Right"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                ...
                <td colspan="4">
                    <span id="investmentdetail" runat="server">
                        <table width="100%">
                            ...
                            <tr>
                                <td style="background-color: #FFFF00; font-weight: bold"><input type="checkbox" 
                                        checked="checked" disabled="disabled">参与</input></td>
                                <td>xxx</td>
                                <td align="right">1</td>
                                <td align="right">
                                    <input id="calVolume11" type="text" value="1000" style="width:80px;text-align:right; background-color: #FFFF00; font-size: large; font-weight: bold; visibility: hidden;" />
                                </td>
